...
export default function GoogleSignInButton({ label }: { label: string }) {
  ...
  return (
    <button
      ...
      className="w-full flex items-center justify-center gap-2.5 border border-navy/15 rounded-xl py-3 text-sm font-semibold text-navy hover:bg-navy/5 transition-colors"
    >
